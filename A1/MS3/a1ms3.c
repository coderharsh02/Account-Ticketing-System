...
int main(void)
{
    ...
    // ---------------------------------------------------------
    // Input (new record)
    getPerson(&account.accountDetails);  // Call function to get user input for a new "Person"

    // ---------------------------------------------------------
    // UserLogin Data
    // ---------------------------------------------------------
    // Input (new record)
    getUserLogin(&account.accountCredential);  // Call function to get user input for a new "UserLogin"
